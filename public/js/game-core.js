(function exposeGameCore(root, factory) {
  ...
  const DEFAULT_PHYSICS = Object.freeze({
    acceleration: 6.6,
    reverseAcceleration: 4.2,
    maxForwardSpeed: 3,
    maxReverseSpeed: 1.44,
    coastDrag: 2.8,
    poweredDrag: 0.5,
    steeringRate: 3.85,
    minimumTurn: 0.24,
  ...
  const VEHICLE_SPECS = Object.freeze({
    ...
    truck: Object.freeze({
      ...
      physics: Object.freeze({
        acceleration: 5.3,
        reverseAcceleration: 3.57,
        maxForwardSpeed: 2.36,
        maxReverseSpeed: 1.2,
        steeringRate: 3.13,
        minimumTurn: 0.2,
        driftSteering: 0.68,
    ...
    tank: Object.freeze({
      ...
      physics: Object.freeze({
        ...
        maxForwardSpeed: 1.62,
        maxReverseSpeed: 1.09,
        steeringRate: 2.7,
        minimumTurn: 0.54,
        driftSteering: 2,
        coastDrag: 3.6,
